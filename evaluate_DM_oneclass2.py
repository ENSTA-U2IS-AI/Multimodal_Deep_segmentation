...
def validate(opts, model, loader_train, loader,embeddings_train, device, metrics, ret_samples_ids=None,nu=0.5,gamma=0.5):
    ...
    print('embeddings_train.size()',embeddings_train.size())
...
def main():
    ...
    embedding =build_data_embedding(opts=opts, model=model, loader_train=train_loader, loader=val_loader, device=device, metrics=metrics,)
    for gamma_i in gammalist:
      for nu0 in nulist:#for gamma_i in gammalist:
          nu=float(nu0)/100.0

          val_score, ret_samples,ece,NLL, auroc_list, aupr_list, fpr_list  = validate(opts=opts, model=model, loader_train=train_loader, loader=val_loader,embeddings_train=embedding, device=device, metrics=metrics,nu=nu,gamma=gamma_i, ret_samples_ids=vis_sample_id)
          print('nu =',nu,'gamma =',gamma_i)
